...
class ChatMessageRobot {
  ...
  final sendMessageInProfile = find.byKey(const Key("send_message_btn"));
  ...
  Future joinChannelInChannelList(channelName)async {
    await widgetTester.pushNewRoute(AppRoute.channelList);
  ...
  Future sendMessageInChannelProfile(channelName)async {
    await widgetTester.pushNewRoute(AppRoute.channelList);
    await widgetTester.pumpAndSettle();
    await widgetTester.pumpAndSettle(const Duration(seconds: 2));
    await widgetTester.enterText(channel_id_input, channelName);
    ...
    await widgetTester.pumpAndSettle();
    await widgetTester.pumpForSeconds(5);
    await widgetTester.tap(sendMessageInProfile);
    await widgetTester.pumpAndSettle();
  }
